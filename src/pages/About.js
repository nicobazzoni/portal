  ...
  return (
    <div className='light'>
      <h1 className='top-0 mb-5'>EOS TIPS</h1>
        ...
        <p>Use Query to select channels in specific conditions. E.g., [Query]Dark Moves – selects all channels that are at zero, but have non-intensity moves. Query can be filtered by fixture type, keywords, and conditions.</p>
          <img src='https://giftv.co/assets/images/image06.gif?v=3176bd34' />
         
          <p>[Sneak] [Sneak]&nbsp; Use to sneak all non-intensity parameters, leaving intensity for associated channels as currently set</p>
        </div>
        <div className="item m-2  p-2 bg">
        <p>Pressing and holding [About] + [Cue] will display the source of current data on stage – by cue list/number and/or sub number. </p>
          <img src='https://media0.giphy.com/media/rdma0nDFZMR32/200w.gif'/>
          
          <p>[Go to Cue] [Home] [Enter] – will go to the first cue of the selected list. [Go to Cue] [Shift] + [Home] [Enter] – will go to the last cue of the selected list.</p>
        </div>
        <div className="item m-2  p-2 bg">
        <p>[Replace with] in blind can be used to query for a specified value and replace with another value. E.g., Cue 1 thru 20 Enter. Channel list @ [Color Palette] [5] [Replace With] [Color Palette] [7] [Enter]</p>
        ...
        <div className="item m-2  p-2 bg">
        <p>       Pressing and holding [About] + [Cue] will display the source of current data on stage  by cue list/number and/or sub number.
Pressing and holding [About] + [Live] will display the DMX values currently being output for channels/parameters.</p>
...
Pressing and holding [About] + [Mark] will display the mark cue for channels/parameters.
        ...
        <div className="item m-2  p-2 bg">
        <p>      [Shift] + [Block] assigns an Intensity Only block to the selected cue.
[Shift] + [at] reselects the last channel and parameter set, leaving the command line open. This command loops five times..</p>
